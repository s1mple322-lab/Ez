...
local function sendAnswers()
    ...
    -- IMPORTANTE: el 2do argumento tiene que ser el roundId REAL
    -- (el que manda el server por StartRound), no un valor fijo.
    -- Si mandás una ronda vieja/incorrecta el server descarta la
    -- respuesta sin tirar error de Lua.
